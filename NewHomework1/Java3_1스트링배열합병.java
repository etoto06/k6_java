...
public class Java3_1스트링배열합병 {
    ...
    static String[] mergeList(String[]s1, String[] s2) {
    	...
    	System.arraycopy(s1, i, s3, j, s1.length);
    	System.arraycopy(s2, i, s3, s1.length, s2.length);
//    	System.arraycopy(복사할배열,복사할배열의 시작값, 붙여넣기배열, 붙여넣기배열 시작값, 복사할 길이);
