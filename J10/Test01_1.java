...
public class Test01_1 {
	public static void main(String[] args) {
		...
		lst.add(s2); //s2는 스트링
		lst.add(i2); // i2는 정수 , 둘이 다른데 다 되는 이유
		//lst
		...
		//ArrayList<String> list = new ArrayList<String>() 이렇게 해도되는데 굳이 뒤에 어레이리스트에는 스트링 안써도됨
		...
		//asList()는 배열을 입력받아 리스트를 만든다 , asLIst는 Arrays라는 클래스에 있다
		print(12, list2);
		
		//****************************
		// boolean addAll(Collection<? extends E> c) - ?는 wild card 사용 *** 중요
		//				/			타입			/변수/
		//<? extends E>는 제네릭 타입을 나타내며, (E자리에 들어가는 클래스에 따라 다름)
		//이는 "E 클래스 또는 그 하위 클래스의 객체를 요소로 가지는 컬렉션을 의미한다.
		//즉, 이 메소드는 현재 컬렉션의 타입과 동일하거나 하위 타입의 객체를 모두 수용할 수 있다.
		//****************************
